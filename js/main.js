...
var green_mat = new box(0, 0, 0, '#008000',2.8 , 0.1, 1.6);
var wall_1 = new box(1.4, 0, 0, '#835C3B', 0.1, 0.2, 1.7);
var wall_2 = new box(-1.4, 0, 0, '#835C3B', 0.1, 0.2, 1.7);
var wall_3 = new box(0, 0, 0.8, '#835C3B', 2.7, 0.2, 0.1);
var wall_4 = new box(0, 0, -0.8, '#835C3B', 2.7, 0.2, 0.1);
...
var white_ball = new ball(-1.0, 0.1, 0, '#FFFFFF');
var ball_1 = new ball(1.0, 0.1, 0, '#FF0000');
var ball_2 = new ball(1.1, 0.1, 0, '#FFFF00');
var ball_3 = new ball(1.2, 0.1, 0, '#008000');
var ball_4 = new ball(1.3, 0.1, 0, '#FF69B4');
